...
<template>
    ...
    <div v-else>
        ...
        <div :class="[
            ...
            />
            <div>
                <p class="text-xs font-base text-gray-800">Berdasarkan data IMT/U</p>
                <p :class="[
                    'text-md font-bold',
                ...
                <p class="text-xs mt-1 text-gray-700 font-medium">Z-score: <span class="font-mono">{{ zScore > 0 ? '+' : '' }}{{ zScore }} SD</span></p>
