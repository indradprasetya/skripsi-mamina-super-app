...
onMounted(async () => {
    ...
    const { data } = await axios.get(route('antropometri.get', { tipe: 'tbu', gender }));
    refData.value = data;
    loading.value = false;
});
...
const chartOptions = computed(() => ({
    ...
    plugins: {
        ...
        title: {
            display: true,
            text: `Grafik TB/U ${props.child.jenis_kelamin === 'L' ? 'Laki-laki' : 'Perempuan'}`,
            color: '#0f172a',
...
// Fungsi penjelasan status gizi TB/U
function explainTBU(z) {
    ...
    <div v-else>
        ...
        <div class="mt-4">
            <div class="flex items-center space-x-3 mb-2">
                ...
                <div>
                    <p class="text-sm font-medium text-gray-700 dark:text-gray-300">TB/U (Z-Score)</p>
